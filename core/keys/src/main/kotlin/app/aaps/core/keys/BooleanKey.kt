...
enum class BooleanKey(
    ...
    GlucoseLowEnabled("glucose_low_enabled", false, R.string.glucose_low_enabled),
    GlucoseFallingEnabled("glucose_falling_enabled", false, R.string.glucose_falling_enabled),
    GlucoseLowPhoneAlarm("glucose_low_phone_alarm", false, R.string.glucose_phone_alarm, R.string.glucose_phone_alarm_summary, dependency = GlucoseLowEnabled),
    GlucoseFallingPhoneAlarm("glucose_falling_phone_alarm", false, R.string.glucose_phone_alarm, R.string.glucose_phone_alarm_summary, dependency = GlucoseFallingEnabled),
