...
enum class UnitDoubleKey(
    ...
    GlucoseLowThreshold("glucose_low_threshold", 70.0, 40, 250, R.string.glucose_threshold, dependency = BooleanKey.GlucoseLowEnabled),
    GlucoseFallingThreshold("glucose_falling_threshold", 90.0, 40, 250, R.string.glucose_threshold, dependency = BooleanKey.GlucoseFallingEnabled),
